...
(function() {
  ...
  window.FeedCollection = (function(_super) {
    ...
    FeedCollection.prototype.url = function(params) {
      return application.url('feeds', params);
    };
    ...
    FeedCollection.prototype.create_from_url = function(url) {
      return $.ajax({
        ...
        failure: function() {
          return application.notification("Could not add feed " + url, 'error');
        }
      });
    };
...
(function() {
  ...
  window.FeedsController = (function(_super) {
    __extends(FeedsController, _super);

    function FeedsController() {
      return FeedsController.__super__.constructor.apply(this, arguments);
    }

    FeedsController.prototype.routes = {
      "feeds": "index",
      "feeds/:id": "show",
      "feeds/create": "create",
    ...
    FeedsController.prototype.destroy = function() {};
