...
public class Google extends HttpServlet {
    ...
    public final static String redirect_uri       = "http://aggregoire.fr:8080/aggregoire/oauth/2/google";
    public final static String javascript_oirings = "http://aggregoire.fr";
